class EmpresaHardwareStatusLive {
  ...
  markPhysicalInactive(card) {
    ...
    card.style.setProperty('background', 'rgba(239, 68, 68, 0.38)', 'important');
    card.style.setProperty('border', '1px solid rgba(239, 68, 68, 0.6)', 'important');
    card.style.setProperty('box-shadow', '0 12px 32px rgba(239, 68, 68, 0.28), inset 0 1px 0 rgba(255, 255, 255, 0.45)', 'important');
