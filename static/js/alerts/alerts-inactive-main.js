            ...
            <div class="modal-section bg-teal-600/10 border border-teal-500/20 rounded-xl p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
                    ${alert.numeros_telefonicos.sort((a, b) => {
                        ...
                        return `
                        <div class="${bgColor} border border-teal-500/10 rounded-lg p-4 flex items-center space-x-3">
                            <div class="w-10 h-10 ${contacto.embarcado === true ? 'bg-green-500' : contacto.disponible ? 'bg-blue-500' : 'bg-red-500'} rounded-full flex items-center justify-center flex-shrink-0">
